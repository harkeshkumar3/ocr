...
public class CmdLineOptions {
	...
	/**
	 * Extract recognition language from command-line parameters. After extraction
	...
	public static String extractReceiptCountry(Vector<String> args) {
		...
		System.out.println("Warning! The receipt will be treated as receipt from USA.\n"
	...
	/**
	 * Extract value of given parameter from command-line parameters. Parameter is
